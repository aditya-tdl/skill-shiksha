...
interface EditTestimonialModalProps {
    isOpen: boolean;
    onClose: () => void;
    onEdit: (id: string, testimonial: any) => Promise<void>;
    testimonial: any | null;
}

export default function EditTestimonialModal({ isOpen, onClose, onEdit, testimonial }: EditTestimonialModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error(err);
            setError(err.response?.data?.message || err.message || "Failed to edit testimonial.");
        } finally {
            setIsSubmitting(false);
        }
    };
